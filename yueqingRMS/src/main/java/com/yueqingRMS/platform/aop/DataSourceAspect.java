...
import com.yueqingRMS.platform.content.SysContent;
import com.yueqingRMS.platform.tools.dataSourceTool.DataSourceContextHolder;
import com.yueqingRMS.platform.util.AppConst;
...
//        HttpSession session = SysContent.getSession();
        ...
        //切换数据库  
        DataSourceContextHolder.setDbType(AppConst.SOURCE_ds1);
        ...
        try {
        	...
        	//切换默认数据库  
            DataSourceContextHolder.setDbType(AppConst.SOURCE_default);
		}
